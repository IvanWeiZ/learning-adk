# Python Unit Testing & Mocking — Complete Guide

> **For:** Java developer learning Python testing (JUnit/Mockito → pytest/unittest.mock)
> **Focus:** Every mocking technique you need for ADK agent development
...
2. [Mock Basics — Mock, MagicMock, AsyncMock](#2-mock-basics)
3. [Patching — Where and How](#3-patching)
4. [side_effect — Dynamic Mock Behavior](#4-side_effect)
5. [spec and spec_set — Type-Safe Mocks](#5-spec-and-spec_set)
6. [Assertion Methods — Verifying Calls](#6-assertion-methods)
7. [Fixtures — Dependency Injection for Tests](#7-fixtures)
8. [Testing Async Code](#8-testing-async-code)
9. [Mocking Generators and Async Generators](#9-mocking-generators)
10. [Mocking Context Managers](#10-mocking-context-managers)
11. [Mocking Properties and Attributes](#11-mocking-properties)
12. [Mocking Class Hierarchies and ABCs](#12-mocking-abcs)
13. [Parametrized Tests](#13-parametrized-tests)
14. [Common Patterns for ADK Testing](#14-adk-testing-patterns)
15. [Anti-Patterns to Avoid](#15-anti-patterns)
...
def fake_fetch(url: str) -> dict:
    if "search" in url:
        ...
        return {"name": "Wei", "role": "developer"}
...
@patch("my_module.async_function")  # returns MagicMock, not AsyncMock!
async def test_bad(mock_func):
    result = await mock_func()  # TypeError: object MagicMock can't be used in await

# ✅ GOOD: explicitly use AsyncMock
@patch("my_module.async_function", new_callable=AsyncMock)
async def test_good(mock_func):
...
async def test_brittle():
    with patch("my_agent.step1") as m1, patch("my_agent.step2") as m2:
        ...
        m1.assert_called_before(m2)  # who cares about internal ordering?
