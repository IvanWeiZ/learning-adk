...
if grep -rn '[0-9]\+b-[a-z].*\.md' adk/*.md python/*.md reference/*.md 2>/dev/null \
   | grep -v '18b-session-latency\|19b-security-checklist\|20b-debugging-guide\|22b-testing-context-setup\|22c-testing-examples\|23b-custom-tools-and-toolsets\|24b-custom-use-cases\|24c-message-passing\|25b-adk-2.0-patterns'; then
