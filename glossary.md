...
See also: [README.md](README.md) for architecture overview | [01-request-lifecycle.md](adk/01-request-lifecycle.md) for a full traced request | [02-when-to-build-what.md](adk/02-when-to-build-what.md) for decision guide
