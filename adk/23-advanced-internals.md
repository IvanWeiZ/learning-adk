...
This file covers the processor pipeline that builds prompts and handles responses, the reason-act loop, and the plugin system. For custom tools, toolsets, and advanced agent patterns, see [23b-custom-tools-and-toolsets.md](23b-custom-tools-and-toolsets.md).
...
- [23b-custom-tools-and-toolsets.md](23b-custom-tools-and-toolsets.md) — Custom tools, A2A, code executors, advanced patterns
