...
_This file continues from [22-testing.md](22-testing.md), which covers MockModel, InMemoryRunner, simplify_events, and creating test dependencies._
...
_Continued in [22d-testing-plugin-examples.md](22d-testing-plugin-examples.md) — plugins, other agent types, mocking dependencies, best practices, and quick reference._
